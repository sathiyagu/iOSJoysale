...
- (void)dismiss
{
	if (self == sharedDialog) {
		...
		if ([self respondsToSelector:@selector(presentingViewController)])
			[[self.view.window.rootViewController presentingViewController] dismissModalViewControllerAnimated:YES];
		else
...
- (void)show
{
	...
	[[self.view.window.rootViewController presentingController] presentModalViewController:self animated:YES];
}
