...
- (void)commonSetup
{
    _defaultFont = [UIFont fontWithName:@"ProximaNova-Regular" size:14.0f];
    _boldFont = [UIFont fontWithName:@"ProximaNova-Bold" size:14.0f];
    _italicFont = [UIFont fontWithName:@"ProximaNova-Regular" size:14.0f];
