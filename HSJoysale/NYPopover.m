...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.textLabel.font = [UIFont fontWithName:appFontRegular size:13];
        self.textLabel.textAlignment = NSTextAlignmentCenter;
        self.textLabel.adjustsFontSizeToFitWidth = YES;
        self.opaque = NO;
        self.textLabel.layer.cornerRadius=13;
...
- (void)drawRect:(CGRect)rect
{
    ...
    //// Color Declarations
    UIColor* gradientColor = headercolor;
    UIColor* gradientColor2 = headercolor;
    UIColor* shadowColor2 = headercolor;
