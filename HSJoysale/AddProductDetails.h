...
@interface AddProductDetails : UIViewController<UITextFieldDelegate,UIPickerViewDataSource,UIPickerViewDelegate,UITextViewDelegate,UITextFieldDelegate,Wsdl2CodeProxyDelegate,UIActionSheetDelegate,UIAlertViewDelegate,UIScrollViewDelegate,UIWebViewDelegate, HRColorPickerViewControllerDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate,ZSSFontsViewControllerDelegate>
{
    //Class Declaration
    ...
    //UI Declaration
    IBOutlet UITableView * addproductTableView;
    ...
    //For title and description textview
    UITextField *actifText;
    UIScrollView * editorscrollView;
    
    //Variable Declaration
    NSMutableArray * responseStr;
    ...
    int ImageIndex;
    int item_id;
    ZSSTextView *storyTextview;
    
    float editorContentHeight;
    
    BOOL scrollEnabled;
    BOOL addproducutEnable;
    int dotLocation;
