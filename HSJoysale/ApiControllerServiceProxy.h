...
@interface ApiControllerServiceProxy : NSObject
@property (weak) id<Wsdl2CodeProxyDelegate> proxyDelegate;
@property (nonatomic,copy)   NSString* url;
@property (nonatomic,retain) ApiControllerService* service;
...
///Origin Return Type:NSString
-(void)getcountdetails:(NSString *)api_username :(NSString *)api_password :(NSString *)userid ;
///Origin Return Type:NSString
