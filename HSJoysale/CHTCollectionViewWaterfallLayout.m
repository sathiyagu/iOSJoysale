...
@property (nonatomic, retain) id <CHTCollectionViewDelegateWaterfallLayout> delegate;
...
- (CGSize)collectionViewContentSize {
  ...
  if (contentSize.height < self.minimumContentHeight) {
    ...
    NSLog(@"content size %f %f",contentSize.height,contentSize.width);
  return contentSize;
}
