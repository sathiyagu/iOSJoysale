...
- (void)setStyle1
{
    self.doBackColor = [UIColor clearColor];//Change Background color
    self.doButtonColor = DO_RGB(255, 255, 255);//Button background color
    self.doCancelColor = DO_RGB(43, 192, 72);
    self.doDestructiveColor = DO_RGB(46, 204, 113);
    
    self.doTitleTextColor = DO_RGB(95, 74, 50);//Header Text color
    self.doButtonTextColor = DO_RGB(51, 74, 93);//Button Text Color
    self.doCancelTextColor = DO_RGB(255, 255, 255);//cancel Text Color
