...
-(BSLoadingView*)showLoaderInframe:(CGRect)frame{
    ...
    BSLoaderRootViewContoller *rootVC=[[BSLoaderRootViewContoller alloc] initWithNibName:@"BSLoaderRootViewContoller" bundle:nil];
    
    //[rootVC pushViewController:loaderView animated:YES];
